...
<body>
    ...
    <div id="introduction">
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if($amount>$savings){
                echo "<p style='color:red'><b>You do not have enough money in your savings kitty to transfer Ksh $formated_amount </b></br></br>
                Savings account balance is Ksh $formate_savings
                </p>";
            }
            else{
                echo "
                <p style='color:blue'><h1>Transfer Ksh $formated_amount </b></h1>
                <table>
                    <tr> 
