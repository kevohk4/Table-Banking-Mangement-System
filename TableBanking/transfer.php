...
<body>
    ...
    <div class="navig">
       <table>
        ...
        <td><a href="loans.php">Loans</a></td>
        </tr>
        </table>
        </div>
        <form name="" action="transfer1.php">
            ...
            if($amount >= 100){
                ...
                <input type='submit' name='transfer' value='Transfer'></p>
                </form>
                ";
            }
            else{
                echo "<p style='color:red'>Not enough money in your savings kitty to transfer to another member </p>";
