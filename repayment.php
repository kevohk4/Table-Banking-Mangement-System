...
<body>
    ...
    <div id="introduction">
    <form method='post' action='repayment2.php' method='POST'>
        <?php
        $current_bal=$_POST['currentBalanace'];
        echo "<input type='hidden' name='currentbal' value='$current_bal'";
        ?>
    <div class='sedrvice'>
    <h1>Repay loan</h1> <p>Enter Amount
